...
import { shortcutScheme } from '../../../schema/shortcut';
import { Database, } from '../../../database/database';
import Icon from '../../utils/icon';
import { PopupSuccessTemplate } from './Success';
import { Shortcut, ShortcutRepository } from '../../../database/repository/shortcut-repository';
    ...
    <div className={S.dialog}>
      ...
      <form className={S.form} onSubmit={onsubmit}>
        ...
        <div className={S.group_actions}>
          <button onClick={cancel} className={[S.btn, S['btn-cancel']].join(" ")} type='button'>Cancelar</button>
